    ...
    return (
      <div className="clickable">
        <div className="clickable-areas">
          <Link className="leftbookcase" to="/games/storytime" coords="-413.51,18.90, -306.92,12.10
"></Link>
  ...
  const GamesBackgroundImg = ({ children }) => {
    return (
      <div className="clickable" style={{ backgroundImage: "url'../images/playroomlinked.png')", height: "100vh", backgroundSize: "cover" }}>
        {children}
        <div>
        {/* <div className="clickable">
           <PlayroomLinked />
